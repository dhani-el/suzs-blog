...
const ReviewSlider = ({ slides, parentWidth, updateCurse, updateLeave }) => {
    ...
    return (
        <div className="Review-slider" style={sliderStyles}>
            <div className="arrows">
                <div className="arrow-left" onClick={goToPrevious} onMouseOver={updateCurse} onMouseLeave={updateLeave}>↼</div>
                <div className="arrow-right" onClick={goToNext} onMouseOver={updateCurse} onMouseLeave={updateLeave}>⇀</div>
            </div>
            ...
            <div className="slider-dots">
                {slides.map((slide, slideIndex) => (
                    <div key={slideIndex} onClick={() => { goToSlide(slideIndex) }} onMouseOver={updateCurse} onMouseLeave={updateLeave}>•</div>
                ))}
            </div>
        </div>
    );
