    ...
    return (
        <div className="login-reminder-overlay">
            ...
            <div className="login-link"
                onMouseOver={updateCurse} onMouseLeave={updateLeave} onClick={updateLeave}
            ><Link to="/login" onMouseOver={updateCurse} onMouseLeave={updateLeave} onClick={updateLeave}>Login</Link></div>
